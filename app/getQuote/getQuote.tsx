    ...
    <>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8 md:p-12">
          ...
          {submitted && <p className="text-red-500 text-center mt-4">Sorry, this feature is coming soon. Please email dylan@dekinnovations.com with your details. We apologize. </p>}
        </div>
      </div>
